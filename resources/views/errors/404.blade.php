...
<body class="min-h-screen flex flex-col items-center justify-center bg-surface-bg">
    <div class="text-center px-6 animate-fade-up">
        ...
        <h1 class="text-2xl font-bold text-ink tracking-tight mb-3">{{ __('errors.404_title') }}</h1>
        <p class="text-ink-muted max-w-md mx-auto mb-8 leading-relaxed">{{ __('errors.404_description') }}</p>
