<nav class="bg-[#f9f9f9] h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 overflow-auto">
    ...
    <ul class="mt-8">
        <li>
            <x-sidebar-link href="{{ route('account.merchant.dashboard') }}" :active="request()->routeIs('account.merchant.dashboard')">
                ...
                <span x-show="open">{{ __('titles.dashboard') }}</span>
            </x-sidebar-link>
    ...
    <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
            <h6 class="text-slate-800 group-hover:text-slate-900 text-[15px] font-semibold px-4 flex-1">Information</h6>
            <svg xmlns="http://www.w3.org/2000/svg"
                class="arrow w-3 h-3 fill-slate-800 group-hover:fill-slate-900 transition-all rotate-90"
        ...
        <ul class="space-y-1 mt-2 pl-4 max-h-[500px] overflow-hidden transition-all duration-300">
            <li>
                <x-sidebar-link href="{{ route('account.merchant.stores') }}" :active="request()->routeIs('account.merchant.stores')">
                    <span class="iconify w-[18px] h-[18px] mr-3" data-icon="solar:shop-linear"></span>
                    <span x-show="open">{{ __('titles.stores') }}</span>
                </x-sidebar-link>


                <x-sidebar-link href="{{ route('account.merchant.profile') }}" :active="request()->routeIs('account.merchant.profile')">

                    <span class="iconify w-[18px] h-[18px] me-3" data-icon="solar:user-linear"></span>
                    <span x-show="open">{{ __('titles.profile') }}</span>
                </x-sidebar-link>
    ...
    <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
            <h6 class="text-slate-800 group-hover:text-slate-900 text-[15px] font-semibold px-4 flex-1">Income</h6>
            <svg xmlns="http://www.w3.org/2000/svg"
                class="arrow w-3 h-3 fill-slate-800 group-hover:fill-slate-900 transition-all"
                viewBox="0 0 492.004 492.004">
                <path
                    d="M382.678 226.804 163.73 7.86C158.666 2.792 151.906 0 144.698 0s-13.968 2.792-19.032 7.86l-16.124 16.12c-10.492 10.504-10.492 27.576 0 38.064L293.398 245.9l-184.06 184.06c-5.064 5.068-7.86 11.824-7.86 19.028 0 7.212 2.796 13.968 7.86 19.04l16.124 16.116c5.068 5.068 11.824 7.86 19.032 7.86s13.968-2.792 19.032-7.86L382.678 265c5.076-5.084 7.864-11.872 7.848-19.088.016-7.244-2.772-14.028-7.848-19.108z"
                    data-original="#000000" />
    ...
    <div class="mt-6">
        <div class="flex items-center cursor-pointer group collapsible-toggle">
            <h6 class="text-slate-800 group-hover:text-slate-900 text-[15px] font-semibold px-4 flex-1">Actions</h6>
            <svg xmlns="http://www.w3.org/2000/svg"
                class="arrow w-3 h-3 fill-slate-800 group-hover:fill-slate-900 transition-all"
                viewBox="0 0 492.004 492.004">
                <path
