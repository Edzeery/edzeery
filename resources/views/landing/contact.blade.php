<x-layouts.landing-layout :title="__('landing.contact_us')">
                ...
                <div class="lg:col-span-2 space-y-8" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="group flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ __('landing.contact_email') }}" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                    ...
                    <div class="group flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-ink text-sm mb-1">{{ __('storefront.phone') }}</h3>
                            <a href="tel:{{ __('landing.contact_phone') }}" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                    ...
                    <div class="group flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-ink text-sm mb-1">{{ __('landing.links') }}</h3>
                            <p class="text-ink-muted">{{ __('landing.contact_address') }}</p>
                            <p class="text-ink-muted">{{ __('landing.contact_address_city') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="group flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-ink text-sm mb-1">{{ __('landing.how_it_works_title') }}</h3>
                            <p class="text-ink-muted">{{ __('landing.contact_hours') }}</p>
                        </div>
                    </div>
                            ...
                            <div class="grid sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <select id="subject" name="subject" required
                                        ...
                                        <option value="general">{{ __('landing.contact_topic_general') }}</option>
                                        <option value="support">{{ __('landing.contact_topic_support') }}</option>
                                        <option value="sales">{{ __('landing.contact_topic_sales') }}</option>
                                        <option value="partnership">{{ __('landing.contact_topic_partnership') }}</option>
                                    </select>
                                </div>
                            </div>
