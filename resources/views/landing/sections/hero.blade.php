        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <div data-aos="fade-up" data-aos-delay="400" class="mt-10 flex flex-wrap gap-4">
                    {{-- Primary CTA --}}
                    @guest
                        <a href="{{ route('register') }}" data-edz-loading
            ...
            <div data-aos="fade-left" data-aos-delay="300" class="relative hidden lg:block">
                <div
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="rounded-lg bg-surface-secondary p-4">
                            <div class="text-xs text-ink-muted mb-2">{{ __('landing.mock_recent_orders') }}</div>
                            @foreach (range(1, 3) as $i)
                                <div
                                    class="flex items-center justify-between py-2 {{ $i < 3 ? 'border-b border-surface-border' : '' }}">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-ink">
                                                {{ __('landing.mock_customer_' . $i) }}</div>
                                            <div class="text-xs text-ink-soft">{{ rand(1, 5) }}
                ...
                <div
                    ...
                    <div>
                        <div class="text-xs text-ink-muted">{{ __('landing.mock_growth') }}</div>
