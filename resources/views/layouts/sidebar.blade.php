                                    ...
                                    @if (isset($item['subItems']))
                                        ...
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            ...
                                            <span
                                                ...
                                                {{ $item['name'] }}
                                                @if (!empty($item['new']))
                                                    <span class="absolute {{ $isRtl ? 'left-10' : 'right-10' }}"
                                            ...
                                            <svg x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                                class="{{ $isRtl ? 'mr-auto' : 'ml-auto' }} w-5 h-5 transition-transform duration-200"
                                                :class="{
                                        ...
                                        <div
                                            ...
                                            <ul class="mt-2 space-y-1 {{ $isRtl ? 'mr-9' : 'ml-9' }}">
                                                @foreach ($item['subItems'] as $subItem)
                                                    <li>
                                                        <a href="{{ $subItem['path'] }}" class="menu-dropdown-item"
                                                            ...
                                                            {{ $subItem['name'] }}
                                                            <span class="flex items-center gap-1 {{ $isRtl ? 'mr-auto' : 'ml-auto' }}">
                                    ...
                                    @else
                                        ...
                                        <a href="{{ $item['path'] }}" class="menu-item group"
                                            ...
                                            <span
                                                ...
                                                @if (!empty($item['new']))
                                                    <span
                                                        class="{{ $isRtl ? 'mr-2' : 'ml-2' }} inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold bg-brand-500 text-white">
                                                        new
                                                    </span>
                                                @endif
                                            </span>
