...
<div class="relative" x-data="{
    ...
    <!-- Notification Button -->
    <button
        class="relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-gray-900 h-11 w-11 hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
    ...
    >
        ...
        <span
            x-show="notifying"
            class="absolute   <?php echo e($alignment); ?> top-0.5 z-1 h-2 w-2 rounded-full bg-orange-400"
        >
            <span
    ...
    <div
        ...
        class="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:<?php echo e($alignment); ?>"
        style="display: none;"
    >
        <!-- Dropdown Header -->
                ...
                <li @click="handleItemClick()">
                    ...
                    >
                        <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                            ...
                            <span
                                class="absolute bottom-0 <?php echo e($alignment); ?> z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900 <?php echo e($notification['status'] === 'online' ? 'bg-success-500' : 'bg-error-500'); ?>"
                            ></span>
                        </span>
...
<?php /**PATH C:\laragon\www\edzeery\resources\views\components\header\notification-dropdown.blade.php ENDPATH**/ ?>