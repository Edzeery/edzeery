...
<?php endif; ?>
                    ...
                    <?php echo $__env->make('livewire.merchant.orders.partials.order-delivery-cascade', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div class="flex justify-end gap-2 pt-2 border-t border-surface-border">
                        ...
                        <button type="submit" class="edz-btn edz-btn--primary" wire:loading.attr="disabled"
                            ...
                            <span><?php echo e(__('merchant_panel.update')); ?></span>
