...
<?php endif; ?>
                            ...
                            <?php elseif($provider['rates_count'] === 0): ?>
                                <span class="edz-badge edz-badge--warning shrink-0"><?php echo e(__('merchant_panel.no_rates_yet')); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </button>
...
<?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentProvider['carrier_capabilities']['price_sync'] ?? false): ?>
...
<?php endif; ?>
                            ...
                            <?php else: ?>
                                <span class="text-xs text-ink-muted"><?php echo e(__('merchant_panel.price_sync_not_supported')); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rateRows !== []): ?>
                            <div class="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-surface-border pt-4">
                                <div class="flex items-center gap-3">
                                    <button type="button" role="switch"
                                        aria-checked="<?php echo e($allRatesActive ? 'true' : 'false'); ?>"
                                        wire:click="toggleAllRatesActive"
                                        aria-label="<?php echo e($allRatesActive ? __('merchant_panel.rates_disable_all') : __('merchant_panel.rates_enable_all')); ?>"
                                        title="<?php echo e($allRatesActive ? __('merchant_panel.rates_disable_all') : __('merchant_panel.rates_enable_all')); ?>"
                                        class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-200 <?php echo e($allRatesActive ? 'bg-brand-500' : 'bg-surface-border'); ?>">
                                        <span class="inline-block h-5 w-5 transform rounded-full bg-white shadow-sm transition-transform duration-200 <?php echo e($allRatesActive ? 'translate-x-[1.25rem] rtl:-translate-x-[1.25rem]' : 'translate-x-0 rtl:translate-x-0'); ?>"></span>
                                    </button>
                                    <div class="text-sm">
                                        <span class="font-medium text-ink"><?php echo e(__('merchant_panel.rates_master_label')); ?></span>
                                        <span class="block text-xs text-ink-muted">
                                            <?php echo e($allRatesActive ? __('merchant_panel.rates_master_enabled') : ($anyRatesInactive ? __('merchant_panel.rates_master_mixed') : __('merchant_panel.rates_master_disabled'))); ?>

                                        </span>
                                    </div>
                                </div>
                                <span class="text-xs text-ink-muted"><?php echo e(trans_choice('merchant_panel.rates_total', count($rateRows), ['count' => count($rateRows)])); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                        ...
                        <div class="divide-y divide-surface-border">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div wire:key="rate-row-<?php echo e($selectedProviderId); ?>-<?php echo e($state['id']); ?>"
                                     class="grid grid-cols-12 gap-3 px-5 py-3.5 items-center hover:bg-surface-secondary/60 transition-colors <?php echo e($hasRateRow && ! $cell['is_active'] ? 'opacity-70' : ''); ?>">
                                    <div class="col-span-12 sm:col-span-6 lg:col-span-4 flex items-center gap-2 min-w-0">
                                        <span class="text-sm font-medium text-ink truncate">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($state['state_code'])): ?>
                                                <span class="edz-code-badge shrink-0"><?php echo e($state['state_code']); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php echo e($state['name']); ?>

                                        </span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRateRow && ! $cell['is_active']): ?>
                                    ...
                                    <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                        <div class="relative max-w-[9rem]">
                                            <input type="number" step="0.01" min="0"
                                                ...
                                                placeholder="—"
                                                <?php if(! $cell['is_active']): ?> disabled <?php endif; ?>>
                                    ...
                                    <div class="col-span-12 sm:col-span-12 lg:col-span-2 lg:justify-self-end">
                                        <div class="flex flex-wrap items-center gap-3 justify-between sm:justify-start lg:justify-end">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRateRow): ?>
                                                <button type="button" role="switch" aria-checked="<?php echo e($cell['is_active'] ? 'true' : 'false'); ?>"
                                                    wire:click="toggleRateActive('<?php echo e($state['id']); ?>')"
                                                    aria-label="<?php echo e($cell['is_active'] ? __('merchant_panel.rate_disable') : __('merchant_panel.rate_enable')); ?>"
                                                    title="<?php echo e($cell['is_active'] ? __('merchant_panel.rate_disable') : __('merchant_panel.rate_enable')); ?>"
                                                    class="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-200 <?php echo e($cell['is_active'] ? 'bg-brand-500' : 'bg-surface-border'); ?>">
                                                    <span class="inline-block h-5 w-5 transform rounded-full bg-white shadow-sm transition-transform duration-200 <?php echo e($cell['is_active'] ? 'translate-x-[1.25rem] rtl:-translate-x-[1.25rem]' : 'translate-x-0 rtl:translate-x-0'); ?>"></span>
                                                </button>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <button type="button"
