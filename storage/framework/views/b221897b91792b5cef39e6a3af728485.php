            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="py-3">
                            <div class="flex items-center gap-[18px]">
                                <div class="w-10 h-10 overflow-hidden rounded-full">
                                    <img src="<?php echo e($campaign['creator']['imageUrl']); ?>" alt="<?php echo e($campaign['creator']['name']); ?>" />
                                </div>
                                <div>
                                    <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                        <?php echo e($campaign['creator']['name']); ?>
                            ...
                            <div class="flex items-center">
                                <div class="flex items-center w-full gap-5">
                                    <div class="w-full max-w-8">
                                        <img src="<?php echo e($campaign['brand']['logo']); ?>" class="size-8" alt="<?php echo e($campaign['brand']['name']); ?>" />
                                    </div>
                                    <div class="truncate">
                        ...
                        <td class="py-3">
                            <div class="flex items-center">
                                <span class="<?php echo e(getStatusClass($campaign['status'])); ?>">
...
</div><?php /**PATH C:\laragon\www\edzeery\resources\views\components\tables\basic-tables\basic-tables-four.blade.php ENDPATH**/ ?>