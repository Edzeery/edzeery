...
<aside id="sidebar"
    ...
    <?php echo e($algin); ?>-0 bg-surface-bg
       text-ink
     h-screen transition-all duration-300 ease-in-out
     z-99999 <?php echo e($isRtl ? 'border-l' : 'border-r'); ?> border-neutral-border dark:border-dark-border"
    x-data="{
        openSubmenus: {},
        init() {
    ...
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        <nav class="mb-6">
            <div class="flex flex-col gap-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupIndex => $menuGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <!-- Menu Group Title -->
                        ...
                        <ul class="flex flex-col gap-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuGroup['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemIndex => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($item['subItems'])): ?>
                                        ...
                                        <button @click="toggleSubmenu(<?php echo e($groupIndex); ?>, <?php echo e($itemIndex); ?>)"
                                            ...
                                            <span
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['new'])): ?>
                                                    <span class="absolute <?php echo e($isRtl ? 'left-10' : 'right-10'); ?>"
                                            ...
                                            <svg x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                                                class="<?php echo e($isRtl ? 'mr-auto' : 'ml-auto'); ?> w-5 h-5 transition-transform duration-200"
                                                :class="{
                                        ...
                                        <div
                                            ...
                                            <ul class="mt-2 space-y-1 <?php echo e($isRtl ? 'mr-9' : 'ml-9'); ?>">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $item['subItems']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <a href="<?php echo e($subItem['path']); ?>" class="menu-dropdown-item"
                                                            ...
                                                            <span class="flex items-center gap-1 <?php echo e($isRtl ? 'mr-auto' : 'ml-auto'); ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a href="<?php echo e($item['path']); ?>" class="menu-item group"
                                            ...
                                            <span
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['new'])): ?>
                                                    <span
                                                        class="<?php echo e($isRtl ? 'mr-2' : 'ml-2'); ?> inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold bg-brand-500 text-white">
                                                        new
                                                    </span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </span>
...
<?php /**PATH C:\laragon\www\edzeery\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>