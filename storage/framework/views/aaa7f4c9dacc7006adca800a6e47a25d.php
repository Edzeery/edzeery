...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <select id="category-parent" class="edz-select" wire:model="parent_id">
                            <option value=""><?php echo e(__('categories.no_parent')); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->parentOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $fullName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editingId && (string) $id === (string) $editingId): ?>
                                    <?php continue; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <option value="<?php echo e($id); ?>" <?php if((string) $parent_id === (string) $id): echo 'selected'; endif; ?>><?php echo e($fullName); ?></option>
        ...
        <div class="grid grid-cols-1 gap-3 border-b border-surface-border p-4 sm:grid-cols-3">
            ...
            <div>
                <select class="edz-select" wire:model.live="is_active">
                    ...
                    <option value="1"><?php echo e(__('categories.active')); ?></option>
                    <option value="0"><?php echo e(__('categories.inactive')); ?></option>
                </select>
            </div>
        </div>
                                ...
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->canDelete()): ?>
                                        <button type="button" class="edz-btn edz-btn--ghost edz-btn--sm text-danger-600 hover:text-danger-700"
                                                x-data
                                                @click.prevent="if (await EdzSwal.confirmDelete('<?php echo e(addslashes($category->name)); ?>')) $wire.delete('<?php echo e($category->id); ?>')"
