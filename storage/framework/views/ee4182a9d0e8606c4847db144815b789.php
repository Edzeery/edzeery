    ...
    <div class="mb-4 flex gap-2">
        ...
        >
            ...
            <span class="ml-1 text-xs opacity-60">
                (<?php echo e($tabCounts['awaiting_verification']); ?>)
            </span>
        </button>
        <button
        ...
        >
            ...
            <span class="ml-1 text-xs opacity-60">
                (<?php echo e($tabCounts['awaiting_processing']); ?>)
            </span>
        </button>
        <button
        ...
        >
            ...
            <span class="ml-1 text-xs opacity-60">
                (<?php echo e($tabCounts['processed']); ?>)
            </span>
        </button>
    </div>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($this->trackings) >= $perPage): ?>
                <div class="flex items-center justify-end gap-2 p-4 border-t">
                    ...
                    <span class="text-sm text-gray-500">
                        <?php echo e(__('titles.page')); ?> <?php echo e($page); ?>
