    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
        ...
        <div>
            ...
            <ul class="space-y-2.5">
                <li><a href="#services" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.services')); ?></a></li>
                <li><a href="#pricing" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.pricing')); ?></a></li>
                <li><a href="#faq" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.faq_title')); ?></a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2.5">
                <li><a href="#" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.about_us')); ?></a></li>
                <li><a href="<?php echo e(route('contact')); ?>" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.contact_us')); ?></a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2.5">
                <li><a href="#" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.privacy_policy')); ?></a></li>
                <li><a href="#" class="text-ink-muted hover:text-brand-600 dark:hover:text-brand-400 transition"><?php echo e(__('landing.terms')); ?></a></li>
            </ul>
        </div>
