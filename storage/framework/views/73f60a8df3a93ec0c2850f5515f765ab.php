...
<div <?php echo e($renderAttributes->merge(['class' => "edz-select $sizeClass $class"])); ?>
...
<?php endif; ?>
            <input type="text" x-model="query" @input="highlighted = -1" @click.stop
                ...
                placeholder="<?php echo e(__('merchant_panel.search_products')); ?>"
...
<?php endif; ?>
        ...
        <div class="edz-product-select__actions" x-show="hasNameFilter">
            <button type="button" @click="applyNameFilter()"
                ...
                <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'funnel','class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal78f5a7347bd00ba3623a459cd340078c); ?>
<?php endif; ?>
                <span><?php echo e(__('merchant_panel.filter_by_full_name')); ?>: "<span x-text="query"></span>"</span>
            </button>
        </div>
...
<?php unset($__componentOriginal78f5a7347bd00ba3623a459cd340078c); ?>
<?php endif; ?>
                <span><?php echo e(__('merchant_panel.clear_filter')); ?></span>
            </button>
        </div>
    </div>
</div>
<?php /**PATH C:\laragon\www\edzeery\resources\views/components/edz/product-select.blade.php ENDPATH**/ ?>