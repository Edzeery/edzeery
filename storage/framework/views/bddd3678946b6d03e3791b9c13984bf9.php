...
<?php endif; ?>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <div class="relative" @click.away="openColToggle = false">
                <button @click="openColToggle = !openColToggle" class="edz-btn edz-btn--ghost edz-btn--sm">
                    <ion-icon name="columns-outline" class="text-base"></ion-icon>
                    <?php echo e(__('Columns')); ?>

                </button>
                <div x-show="openColToggle" x-transition
                     class="absolute z-40 mt-1 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-2 space-y-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['number'=>'#','customer'=>'Customer','phone'=>'Phone','wilaya'=>'Wilaya','products'=>'Products','amount'=>'Amount','status'=>'Status','assigned_agent'=>'Agent','created_at'=>'Date','confirmation_attempts'=>'Attempts','last_contact'=>'Last Contact','weight'=>'Weight','shipment_type'=>'Shipment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-sm">
            ...
            <input type="text" wire:model.blur.debounce.300ms="filters.number"
                   wire:change="$setFilter('number', $event.target.value)"
                   placeholder="#Order" class="edz-input text-sm w-28">

            <input type="text" wire:model.blur.debounce.300ms="filters.customer"
                   wire:change="$setFilter('customer', $event.target.value)"
                   placeholder="Customer" class="edz-input text-sm w-32">

            <input type="text" wire:model.blur.debounce.300ms="filters.phone"
                   wire:change="$setFilter('phone', $event.target.value)"
                   placeholder="Phone" class="edz-input text-sm w-32">
            ...
            <div class="relative" @click.away="openFilter = null">
                <button @click="openFilter = openFilter === 'status' ? null : 'status'"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($this->filters['status'])): ?>
                        <span class="ml-1 px-1.5 py-0.5 text-[10px] rounded-full bg-accent-100 text-accent-700"><?php echo e(count($this->filters['status'])); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </button>
                <div x-show="openFilter === 'status'" x-transition
                     class="absolute z-40 mt-1 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-2 max-h-60 overflow-y-auto">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->allStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer text-sm">
                            ...
                            <span class="w-2 h-2 rounded-full" style="background: <?php echo e($s['color'] === 'gray' ? '#6b7280' : ($s['color'] === 'info' ? '#3b82f6' : ($s['color'] === 'success' ? '#22c55e' : ($s['color'] === 'warning' ? '#f59e0b' : '#ef4444')))); ?>"></span>
                            <?php echo e($s['label']); ?>
            ...
            <input type="date" wire:model.blur="filters.date_from"
                   wire:change="$setFilter('date_from', $event.target.value)"
                   class="edz-input text-sm w-36" placeholder="From">

            <input type="date" wire:model.blur="filters.date_to"
                   wire:change="$setFilter('date_to', $event.target.value)"
                   class="edz-input text-sm w-36" placeholder="To">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(array_filter($this->filters)): ?>
                <button wire:click="clearFilters" class="edz-btn edz-btn--ghost edz-btn--xs text-red-500">
    ...
    <div class="edz-card overflow-hidden">
        <div class="relative">
            ...
            <div wire:loading class="absolute inset-0 z-10 bg-surface/80 backdrop-blur-sm p-4 space-y-3 overflow-hidden" wire:target="filters,loadOrders">
                            ...
                            <thead class="bg-secondary">
                                <tr>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('number', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">#</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('customer', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Customer</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('phone', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Phone</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('wilaya', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Wilaya</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('products', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Products</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('amount', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Amount</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('assigned_agent', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Agent</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('confirmation_attempts', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Attempts</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('last_contact', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Last Contact</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('weight', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Weight</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('shipment_type', $this->visibleColumns)): ?>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-ink-muted uppercase">Shipment</th>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <th class="px-4 py-3 text-right text-xs font-semibold text-ink-muted uppercase">Actions</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-surface-100 dark:divide-ink-800">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $orders['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="hover:bg-surface-50 dark:hover:bg-ink-800/50">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('customer', $this->visibleColumns)): ?>
                                            <td class="px-4 py-3">
                                                <div class="text-ink font-medium"><?php echo e($order['customer']['name'] ?? '-'); ?></div>
                                            </td>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array('phone', $this->visibleColumns)): ?>
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                                                    <button @click="open = !open"
                                                            class="inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full cursor-pointer hover:opacity-80"
                                                        ...
                                                        <ion-icon name="chevron-down-outline" class="text-[10px]"></ion-icon>
                                                    </button>
                                                    <div x-show="open" x-transition
                                                         class="absolute z-50 mt-1 w-52 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg p-1.5 max-h-64 overflow-y-auto">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->allStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($s['key'], $transitions) || $s['id'] == $order['status_id']): ?>
                                                                <button wire:click="transitionOrder('<?php echo e($order['id']); ?>', '<?php echo e($s['key']); ?>')"
                                                                        @click="open = false"
                                                                        class="w-full text-left flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-xs hover:bg-gray-50 dark:hover:bg-gray-700 <?php echo e($s['id'] == $order['status_id'] ? 'font-bold' : ''); ?>">
                                                                    <span class="w-2 h-2 rounded-full shrink-0" style="background: <?php echo e(match($s['color'] ?? 'gray') { 'success' => '#22c55e', 'info' => '#3b82f6', 'warning' => '#f59e0b', 'danger' => '#ef4444', default => '#6b7280' }); ?>"></span>
                                                                    <?php echo e($s['label']); ?>
                                        ...
                                        <td class="px-4 py-3 text-right">
                                            <div class="flex items-center justify-end gap-1">
                                                <button wire:click="toggleDetail('<?php echo e($order['id']); ?>')"
                                                        class="edz-btn edz-btn--ghost edz-btn--xs" title="Details"
                                                        :class="$expandedOrderId === '<?php echo e($order['id']); ?>' ? 'text-primary-500' : ''">
                                                    <ion-icon name="<?php echo e($expandedOrderId === $order['id'] ? 'chevron-up' : 'chevron-down'); ?>-outline" class="text-sm"></ion-icon>
                                                </button>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(canStore(\App\Enums\Store\StorePermissionEnum::ORDER_MANAGE->value)): ?>
                                                    <button wire:click="openEditModal('<?php echo e($order['id']); ?>')"
                                                            class="edz-btn edz-btn--ghost edz-btn--xs" title="Edit">
                                                        <ion-icon name="create-outline" class="text-sm"></ion-icon>
                                                    </button>
                                                    <button wire:click="openReassignModal('<?php echo e($order['id']); ?>')"
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(canStore(\App\Enums\Store\StorePermissionEnum::ORDER_DELETE->value)): ?>
                                                    <button wire:click="deleteOrder('<?php echo e($order['id']); ?>')"
                                                            class="edz-btn edz-btn--ghost edz-btn--xs text-red-500"
                                                            x-data x-on:click="if(!confirm('Delete this order?')) $event.preventDefault()"
                                                            title="Delete">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expandedOrderId === $order['id']): ?>
                                        <tr>
                                            <td colspan="99" class="px-4 py-4 bg-surface-50 dark:bg-ink-800/30">
                                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                                                    <div>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order['items_summary'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="flex justify-between py-1 border-b border-surface-200 dark:border-ink-700">
                                                                <span class="text-ink-muted"><?php echo e($item['name']); ?> ×<?php echo e($item['qty']); ?></span>
                                                                <span class="font-medium text-ink"><?php echo e(currency($item['price'] * $item['qty'])); ?></span>
                                                            </div>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    ...
                                                    <div>
                                                        ...
                                                        <dl class="space-y-1 text-ink-muted">
                                                            <div class="flex justify-between"><dt>Delivery:</dt><dd class="text-ink capitalize"><?php echo e($order['delivery_type'] ?? '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Shipment:</dt><dd class="text-ink capitalize"><?php echo e($order['shipment_type'] ?? '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Payment:</dt><dd class="text-ink uppercase"><?php echo e($order['payment_method'] ?? '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Weight:</dt><dd class="text-ink"><?php echo e($order['weight_kg'] ? $order['weight_kg'] . ' kg' : '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Phone 2:</dt><dd class="text-ink"><?php echo e($order['phone_secondary'] ?? '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Address:</dt><dd class="text-ink"><?php echo e($order['address'] ?? '—'); ?></dd></div>
                                                        </dl>
                                                    </div>
                                                    <div>
                                                        <h4 class="font-semibold text-ink mb-2">Assignment</h4>
                                                        <dl class="space-y-1 text-ink-muted">
                                                            <div class="flex justify-between"><dt>Agent:</dt><dd class="text-ink"><?php echo e($order['assigned_membership']['user']['name'] ?? '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Method:</dt><dd class="text-ink capitalize"><?php echo e($order['assignment_method'] ?? '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Created by:</dt><dd class="text-ink"><?php echo e($order['created_by_membership_id'] ? ($order['created_by_membership']['user']['name'] ?? '—') : '—'); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Attempts:</dt><dd class="text-ink"><?php echo e($order['confirmation_attempts'] ?? 0); ?></dd></div>
                                                            <div class="flex justify-between"><dt>Last contact:</dt><dd class="text-ink"><?php echo e($order['last_contact_at'] ? \Carbon\Carbon::parse($order['last_contact_at'])->diffForHumans() : '—'); ?></dd></div>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($order['notes'])): ?>
                                                                <div class="mt-2 p-2 bg-surface-100 dark:bg-ink-700 rounded-lg text-ink-muted italic">"<?php echo e($order['notes']); ?>"</div>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </dl>
                                                    </div>
                                                </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex gap-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orders['current_page'] > 1): ?>
                                        <button wire:click="$setPage(<?php echo e($orders['current_page'] - 1); ?>)" class="edz-btn edz-btn--ghost edz-btn--xs">&laquo;</button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($orders['current_page'] < $orders['last_page']): ?>
                                        <button wire:click="$setPage(<?php echo e($orders['current_page'] + 1); ?>)" class="edz-btn edz-btn--ghost edz-btn--xs">&raquo;</button>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCreateModal || $showEditModal): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4" x-data>
            <div class="absolute inset-0 bg-black/50 backdrop-blur-sm" x-on:click="$wire.set('<?php echo e($showEditModal ? 'showEditModal' : 'showCreateModal'); ?>', false)"></div>
            <div class="relative w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
                <div class="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between z-10">
                    <h3 class="text-lg font-bold text-ink"><?php echo e($showEditModal ? __('Edit Order') : __('New Order')); ?></h3>
                    <div class="flex items-center gap-2">
                        <button wire:click="<?php echo e($showEditModal ? 'submitEdit' : 'submitCreate'); ?>" class="edz-btn edz-btn--primary edz-btn--sm">
                            <?php echo e($showEditModal ? __('Update') : __('Create')); ?>

                        </button>
                        <button type="button" class="edz-btn edz-btn--ghost edz-btn--sm"
                                x-on:click="$wire.set('<?php echo e($showEditModal ? 'showEditModal' : 'showCreateModal'); ?>', false)">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model="form.state_id" class="edz-input text-sm">
                                <option value="">—</option>
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($formProductResults)): ?>
                            <div class="border border-gray-200 dark:border-gray-700 rounded-lg max-h-40 overflow-y-auto mb-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $formProductResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button wire:click="addFormItem('<?php echo e($pv['id']); ?>')"
                                            class="w-full text-left px-3 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700 flex justify-between">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($form['items'])): ?>
                            <div class="space-y-2 mt-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $form['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-3 p-2 bg-gray-50 dark:bg-gray-800 rounded-lg text-sm">
                                        <span class="flex-1 truncate"><?php echo e($item['name']); ?></span>
                                        ...
                                        <span class="text-ink-muted w-20 text-right"><?php echo e(currency($item['price'] * $item['quantity'])); ?></span>
                                        <button wire:click="removeFormItem(<?php echo e($idx); ?>)" class="text-red-400 hover:text-red-600">
                                            <ion-icon name="close-outline"></ion-icon>
                                        </button>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <div class="text-right font-bold text-ink pt-2 border-t">
                                    Total: <?php echo e(currency(collect($form['items'])->sum(fn($i) => $i['price'] * $i['quantity']))); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showReassignModal): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4" x-data>
            <div class="absolute inset-0 bg-black/50 backdrop-blur-sm" x-on:click="$wire.set('showReassignModal', false)"></div>
            <div class="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <button type="button" class="edz-btn edz-btn--ghost edz-btn--sm" x-on:click="$wire.set('showReassignModal', false)">
                        <ion-icon name="close-outline" class="text-lg"></ion-icon>
                    </button>
                </div>
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button" class="edz-btn edz-btn--ghost edz-btn--sm" x-on:click="$wire.set('showReassignModal', false)"><?php echo e(__('Cancel')); ?></button>
                        <button wire:click="submitReassign" class="edz-btn edz-btn--primary edz-btn--sm"><?php echo e(__('Reassign')); ?></button>
                    </div>
                </div>
            </div>
        </div>
