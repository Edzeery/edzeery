...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge','data' => ['domain' => 'stores','status' => $store['store_status']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'stores','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($store['store_status'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
