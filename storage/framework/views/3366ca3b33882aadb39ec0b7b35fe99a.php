...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.panel','data' => ['title' => $title,'description' => $description,'context' => 'merchant','sidebar' => 'merchant']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description),'context' => 'merchant','sidebar' => 'merchant']); ?>
    <?php echo e($slot); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\edzeery\resources\views\components\layouts\merchant.blade.php ENDPATH**/ ?>