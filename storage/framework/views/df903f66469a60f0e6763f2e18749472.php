<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($optionModalRow !== null): ?>
    <?php
...
<?php endif; ?>
<?php $component->withAttributes(['isOpen' => true,'showCloseButton' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'preventClose' => true,'size' => 'lg','wire:key' => 'create-option-modal-'.e($optionModalRow).'-'.e($optionModalCreatedId ?? 'new').'']); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($optionModalCreatedId === null): ?>
            
            <span class="edz-modal__handle"></span>

            <div class="edz-card__header">
                <div>
                    <h2 class="edz-card__title"><?php echo e(__('products.new_option')); ?></h2>
                    <p class="text-sm text-ink-400"><?php echo e(__('product_options.new_option_desc')); ?></p>
                </div>
            ...
            <div class="edz-card__body">
                <div class="space-y-4">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div class="edz-field">
                            <label class="edz-field__label" for="inline-option-name"><?php echo e(__('product_options.name')); ?></label>
                            <input id="inline-option-name" type="text" class="edz-input <?php $__errorArgs = ['optionModal.name'];
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   placeholder="<?php echo e(__('product_options.option_name')); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['optionModal.name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="edz-field">
                            <label class="edz-field__label" for="inline-option-type"><?php echo e(__('product_options.input_type')); ?></label>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.select','data' => ['wire:model' => 'optionModal.type','options' => $this->optionInputTypes,'placeholder' => ''.e(__('product_options.select_type')).'','error' => $errors->first('optionModal.type'),'icon' => 'list-bullet']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'optionModal.type','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->optionInputTypes),'placeholder' => ''.e(__('product_options.select_type')).'','error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('optionModal.type')),'icon' => 'list-bullet']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="mt-4 flex items-center justify-end gap-2 border-t border-surface-border pt-4">
                        ...
                        <button type="button" wire:click="createOptionInline" class="edz-btn edz-btn--primary edz-btn--sm">
                            <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'check','class' => 'h-4 w-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'check','class' => 'h-4 w-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal78f5a7347bd00ba3623a459cd340078c)): ?>
<?php $attributes = $__attributesOriginal78f5a7347bd00ba3623a459cd340078c; ?>
...
<?php endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="edz-card__header">
                <div>
                    <h2 class="edz-card__title"><?php echo e($inlineOption?->name ?? __('products.new_option')); ?></h2>
                    <p class="text-sm text-ink-400"><?php echo e(__('products.new_option_done')); ?></p>
                </div>
                <button type="button" wire:click="closeOptionModal"
                        class="edz-btn edz-btn--ghost edz-btn--sm shrink-0"
                        aria-label="<?php echo e(__('buttons.close')); ?>"
...
<?php endif; ?>
            ...
            <div class="edz-card__body">
                <div class="mb-2 flex items-center justify-between gap-2">
                    <h3 class="text-sm font-semibold text-ink"><?php echo e(__('products.values')); ?></h3>
                    <span class="text-xs text-ink-muted">
                        <?php echo e(__('products.selected_count', ['count' => $this->optionValuesByOption->get($optionModalCreatedId, collect())->count()])); ?>

                    </span>
                </div>

                <div class="flex flex-wrap gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->optionValuesByOption->get($optionModalCreatedId, collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <span class="edz-multi-select__chip">
                            <span class="edz-multi-select__chip-label"><?php echo e($optionValue->value); ?></span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(canStore(\App\Enums\Store\StorePermissionEnum::PRODUCT_UPDATE->value)): ?>
                                <button type="button"
                                        wire:click="removeOptionValueInline('<?php echo e($optionValue->id); ?>')"
                                        wire:loading.attr="disabled"
                                        :aria-label="'<?php echo e(__('buttons.remove')); ?>'"
                                        title="<?php echo e(__('products.remove_option')); ?>"
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(canStore(\App\Enums\Store\StorePermissionEnum::PRODUCT_UPDATE->value)): ?>
                    <div class="mt-5 rounded-lg border border-surface-border p-4">
                        <label class="edz-field__label" for="inline-option-value"><?php echo e(__('products.new_value')); ?></label>
...
<?php endif; ?>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH C:\laragon\www\edzeery\resources\views/livewire/merchant/products/form/create-option-modal.blade.php ENDPATH**/ ?>