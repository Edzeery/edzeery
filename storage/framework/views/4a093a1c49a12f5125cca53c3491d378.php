...
<div x-data="{ open: false }"
     x-show="$wire.sections.includes('<?php echo e($key); ?>')"
...
<?php endif; ?></span>
    ...
    <div id="section-editor-<?php echo e($key); ?>" role="region" aria-label="<?php echo e($section['label']); ?>" x-show="open" x-cloak x-transition.duration.200ms>
        <div class="p-5 space-y-4">
            ...
            <?php else: ?>
                <?php echo $__env->make('livewire.merchant.storefront-settings.fields.title-only', ['path' => 'section_content.' . $key], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\edzeery\resources\views\livewire\merchant\storefront-settings\partials\section-editor.blade.php ENDPATH**/ ?>