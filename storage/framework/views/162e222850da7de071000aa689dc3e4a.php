<section id="services" class="py-24 bg-gray-50 dark:bg-[#0a0a0a]">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mb-16">
            ...
            >
                <?php echo e(__('landing.services_title')); ?>
            ...
            >
                <?php echo e(__('landing.services_subtitle')); ?>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                ...
                <div
                    data-aos="fade-up"
                    data-aos-delay="<?php echo e($loop->index * 80); ?>"
                ...
                >
                    <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-<?php echo e($feature['color']); ?>-50 dark:bg-<?php echo e($feature['color']); ?>-950/40 mb-5">
                        <ion-icon name="<?php echo e($feature['icon']); ?>" class="text-<?php echo e($feature['color']); ?>-600 dark:text-<?php echo e($feature['color']); ?>-400 text-xl"></ion-icon>
                    </div>
...
<?php /**PATH C:\laragon\www\edzeery\resources\views/landing/sections/services.blade.php ENDPATH**/ ?>