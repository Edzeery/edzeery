<div class="relative" x-data="{
    ...
    <button class="flex items-center text-gray-700 dark:text-gray-400" @click.prevent="toggleDropdown()" type="button">
        ...
        <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->profile?->profile_picture): ?>
              <img src="<?php echo e(asset('/storage/img/users/profiles/' .auth()->user()->profile->profile_picture)); ?>" alt="User" />
            <?php else: ?>
              <img src="<?php echo e(asset('img/icons/noimg.png')); ?>" alt="User" />
    ...
    <div x-show="dropdownOpen" x-transition:enter="transition ease-out duration-100"
        ...
        class="absolute <?php echo e($alignment); ?> mt-[17px]
...
<?php /**PATH C:\laragon\www\edzeery\resources\views\components\header\user-dropdown.blade.php ENDPATH**/ ?>