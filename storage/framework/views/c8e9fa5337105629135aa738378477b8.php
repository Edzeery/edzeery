...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($rects)): ?>
    <div class="inline-flex flex-col items-center gap-1" dir="ltr">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 <?php echo e($width); ?> <?php echo e($height); ?>"
            width="<?php echo e($width); ?>" height="<?php echo e($height); ?>" shape-rendering="crispEdges"
            role="img" aria-label="<?php echo e($value); ?>" <?php echo e($attributes); ?>>
            <g fill="currentColor">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <rect x="<?php echo e($rect['x']); ?>" y="0" width="<?php echo e($rect['w']); ?>" height="<?php echo e($height); ?>" />
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showText): ?>
            <span class="font-mono text-[11px] leading-none tracking-wide text-ink-muted break-all"><?php echo e($value); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH C:\laragon\www\edzeery\resources\views\components\edz\barcode.blade.php ENDPATH**/ ?>