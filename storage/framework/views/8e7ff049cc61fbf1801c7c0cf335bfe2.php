...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['providers' => [], 'selectedProviderId' => null]));
...
foreach (array_filter((['providers' => [], 'selectedProviderId' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<aside class="edz-card edz-card--padded lg:sticky lg:top-4">
    ...
    <div class="flex lg:flex-col gap-2 overflow-x-auto lg:overflow-visible">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button"
                aria-pressed="<?php echo e($selectedProviderId === $provider['id'] ? 'true' : 'false'); ?>"
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($provider['is_integrated']): ?>
                    <span title="<?php echo e(__('merchant_panel.stopdesk_sync_desc')); ?>"
                        class="shrink-0 <?php echo e($selectedProviderId === $provider['id'] ? 'text-brand-500' : 'text-ink-muted'); ?>">
                        <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'arrow-path','class' => 'w-3.5 h-3.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <span class="edz-badge <?php echo e($selectedProviderId === $provider['id'] ? 'edz-badge--info' : 'edz-badge--neutral'); ?> shrink-0">
                    <?php echo e($provider['points_count']); ?>

                </span>
            </button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</aside><?php /**PATH C:\laragon\www\edzeery\resources\views\livewire\merchant\delivery\partials\stopdesk-provider-sidebar.blade.php ENDPATH**/ ?>