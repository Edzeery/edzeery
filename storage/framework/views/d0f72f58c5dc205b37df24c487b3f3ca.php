...
<input <?php if($disabled): echo 'disabled'; endif; ?>
    <?php echo e($attributes->merge([
        'class' =>
            'border border-neutral-border dark:border-dark-border rounded-lg px-3 py-2 w-full text-ink bg-neutral-surface dark:bg-dark-surface focus:outline-none focus:ring-2 focus:ring-brand focus:border-brand transition',
    ])); ?> />
