...
new class extends Component implements Livewire\Volt\Contracts\FunctionalComponent
{
    ...
    #[\Livewire\Attributes\Computed()]
    public function roleTemplatePermissions(): array
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('roleTemplatePermissions'))->execute(...$arguments);
    }
    ...
    public function permissionGroups(): array
    {
        ...
        return (new Actions\CallMethod('permissionGroups'))->execute(...$arguments);
    }

    #[\Livewire\Attributes\Computed()]
    public function activeGroupMeta(): ?array
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('activeGroupMeta'))->execute(...$arguments);
    }

    public function openPermissionGroup(string $group): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('openPermissionGroup'))->execute(...$arguments);
    }

    public function closePermissionGroup(): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('closePermissionGroup'))->execute(...$arguments);
    }

    public function savePermissionGroup(): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('savePermissionGroup'))->execute(...$arguments);
    }

    public function togglePermission(string $permission, bool $checked): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('togglePermission'))->execute(...$arguments);
    }
    ...
    public function selectGroupPermissions(string $group): void
    {
        ...
        (new Actions\CallMethod('selectGroupPermissions'))->execute(...$arguments);
    }

    public function clearGroupPermissions(string $group): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('clearGroupPermissions'))->execute(...$arguments);
    }

    public function selectRoleTemplate(): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('selectRoleTemplate'))->execute(...$arguments);
    }
    ...
    public function clearAllPermissions(): void
    {
        ...
        (new Actions\CallMethod('clearAllPermissions'))->execute(...$arguments);
    }
