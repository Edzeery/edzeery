...
<div x-data="{ open: false }" class="relative">
    ...
    <div
        ...
        class="absolute <?php echo e($alignment); ?> mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50"
    >
        <div class="p-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($count === 0): ?>
                <div class="py-8 text-center">
                    ...
                    <button x-on:click="open = false" class="mt-3 text-sm font-medium store-text-primary hover:underline"><?php echo e(__('storefront.back_to_store')); ?></button>
                </div>
            <?php else: ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 text-sm">
                            ...
                            <div class="text-right shrink-0">
                                ...
                                ><?php echo e(__('storefront.remove')); ?></button>
                            </div>
                        </div>
