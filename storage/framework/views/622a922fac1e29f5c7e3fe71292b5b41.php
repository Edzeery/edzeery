...
<div x-data="{ open: <?php if ((object) ('isOpen') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'->value()); ?>')<?php echo e('isOpen'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isOpen'); ?>')<?php endif; ?> }" class="relative">
    ...
    >
        <div class="p-4">
            <h3 class="font-semibold text-gray-900 dark:text-white mb-3 flex items-center justify-between">
                ...
                <span class="text-sm font-normal text-gray-500"><?php echo e($count); ?> <?php echo e(__('items')); ?></span>
            </h3>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($count === 0): ?>
                <p class="text-sm text-gray-500 dark:text-gray-400 text-center py-6"><?php echo e(__('Your cart is empty')); ?></p>
            <?php else: ?>
                <div class="space-y-3 max-h-60 overflow-y-auto">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 text-sm">
                            <div class="flex-1 min-w-0">
                                <p class="font-medium text-gray-900 dark:text-white truncate"><?php echo e($item['product_name']); ?></p>
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    <button
                                        wire:click="$wire.updateQty('<?php echo e($item['variant_id']); ?>', <?php echo e($item['quantity'] - 1); ?>)"
                            ...
                            <div class="text-right shrink-0">
                                <p class="font-semibold text-gray-900 dark:text-white"><?php echo e(currency($item['price'] * $item['quantity'])); ?></p>
                                <button
                                    x-data
                                    @click.prevent="if (await EdzSwal.confirmAction('<?php echo e(__('Remove')); ?>', '<?php echo e(__('messages.action_confirm_delete')); ?>')) $wire.removeItem('<?php echo e($item['variant_id']); ?>')"
