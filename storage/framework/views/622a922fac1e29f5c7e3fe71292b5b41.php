...
<div x-data="{ open: false }" class="relative" wire:poll.5s="refreshCart" x-on:cart-updated.window="$wire.refreshCart()">
    ...
    <div x-show="open" x-on:click.away="open = false" x-transition:enter="transition ease-out duration-200"
        ...
        <div x-show="open"
            ...
            class="fixed bottom-0 inset-x-0 sm:absolute sm:<?php echo e($alignment); ?> sm:mt-2 sm:w-80 max-h-[85vh] bg-white dark:bg-gray-800 sm:rounded-xl rounded-t-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
