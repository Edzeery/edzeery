...
<div x-data="{
    ...
    init() {
        this.$nextTick(() => {
            this.flatpickrInstance = flatpickr(this.$refs.dateInput, {
                ...
                defaultDate: <?php echo e($defaultDate ? (is_array($defaultDate) ? json_encode($defaultDate) : "'" . $defaultDate . "'") : 'null'); ?>,
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($label): ?>
        <label for="<?php echo e($id); ?>" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
            <?php echo e($label); ?>
...
<?php /**PATH C:\laragon\www\edzeery\resources\views\components\form\date-picker.blade.php ENDPATH**/ ?>