...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.select','data' => ['wire:model.live' => 'typeFilter','options' => $this->typeOptions,'placeholder' => ''.e(__('general.all')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'typeFilter','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->typeOptions),'placeholder' => ''.e(__('general.all')).'']); ?>
