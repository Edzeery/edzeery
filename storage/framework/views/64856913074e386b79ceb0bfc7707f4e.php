...
new class extends Component implements Livewire\Volt\Contracts\FunctionalComponent
{
    ...
    public $optionModalRow;

    public $optionModalCreatedId;

    public $optionNewValue;

    public $quickValueDraft;

    public $currentStep;

    public $validated_steps;
    ...
    #[\Livewire\Attributes\Computed()]
    public function optionInputTypes()
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('optionInputTypes'))->execute(...$arguments);
    }
    ...
    public function openCreateOption(?int $index = NULL): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('openCreateOption'))->execute(...$arguments);
    }

    public function createOptionInline(): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('createOptionInline'))->execute(...$arguments);
    }

    public function addOptionValueInline(): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('addOptionValueInline'))->execute(...$arguments);
    }

    public function quickAddValue(int $index): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('quickAddValue'))->execute(...$arguments);
    }

    public function removeOptionValueInline(string $valueId): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('removeOptionValueInline'))->execute(...$arguments);
    }
    ...
    public function closeOptionModal(): void
    {
        ...
        (new Actions\CallMethod('closeOptionModal'))->execute(...$arguments);
    }
    ...
    public function makeMainImage(int $index): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('makeMainImage'))->execute(...$arguments);
    }
    ...
    public function removeVariantImage(int $index): void
    {
        ...
        (new Actions\CallMethod('removeVariantImage'))->execute(...$arguments);
    }
    ...
    #[\Livewire\Attributes\Computed()]
    public function lockedSteps()
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('lockedSteps'))->execute(...$arguments);
    }
    ...
    protected function adjacentVisibleStep(int $from, int $direction): ?int
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('adjacentVisibleStep'))->execute(...$arguments);
    }

    
    protected function isStepUnlocked(int $step): bool
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('isStepUnlocked'))->execute(...$arguments);
    }
