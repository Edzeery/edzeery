...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/storefront.js', 'resources/js/edz-loader.js']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.fonts','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($store->landing_template?->value === 'single_product')): ?>
                    <?php
...
?>
    ...
    <div x-data="edzNotice()" x-on:edz-notice.window="show($event.detail)" x-cloak
        class="fixed bottom-24 <?php echo e(isRTL() ? 'start-6' : 'end-6'); ?> z-[70] pointer-events-none">
    ...
    <div x-data="cartToast()" x-on:cart-updated.window="show()" x-cloak
        class="fixed bottom-6 <?php echo e(isRTL() ? 'start-6' : 'end-6'); ?> z-[70] pointer-events-none">        <div x-show="visible" x-transition:enter="transition ease-out duration-300"
            x-transition:enter-start="opacity-0 translate-y-4 scale-95"
            x-transition:enter-end="opacity-100 translate-y-0 scale-100"
            x-transition:leave="transition ease-in duration-200"
            x-transition:leave-start="opacity-100 translate-y-0 scale-100"
