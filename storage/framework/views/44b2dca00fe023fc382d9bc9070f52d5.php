...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.loading-target','data' => ['action' => 'bulkDeleteOrders','label' => __('merchant.bulk_processing')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => 'bulkDeleteOrders','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('merchant.bulk_processing'))]); ?>
...
<?php if (isset($component)) { $__componentOriginalf87f3db323d8b56174a8e5f280367253 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf87f3db323d8b56174a8e5f280367253 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.loading-target','data' => ['action' => 'runBulkValidate','label' => __('merchant.bulk_processing')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.loading-target'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => 'runBulkValidate','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('merchant.bulk_processing'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf87f3db323d8b56174a8e5f280367253)): ?>
<?php $attributes = $__attributesOriginalf87f3db323d8b56174a8e5f280367253; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.spinner','data' => ['class' => 'w-4 h-4','wire:loading' => true,'wire:target' => 'openBulkTrackingReassignModal,submitTrackingReassign,runBulkValidate,bulkDeleteOrders','wire:key' => 'tracking-bulk-spinner']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4','wire:loading' => true,'wire:target' => 'openBulkTrackingReassignModal,submitTrackingReassign,runBulkValidate,bulkDeleteOrders','wire:key' => 'tracking-bulk-spinner']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'bars-2','class' => 'w-4 h-4','wire:loading.remove' => true,'wire:target' => 'openBulkTrackingReassignModal,submitTrackingReassign,runBulkValidate,bulkDeleteOrders']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'bars-2','class' => 'w-4 h-4','wire:loading.remove' => true,'wire:target' => 'openBulkTrackingReassignModal,submitTrackingReassign,runBulkValidate,bulkDeleteOrders']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <span class="inline-flex items-center justify-center min-w-5 h-5 px-1.5 rounded-full bg-accent-fg text-accent text-[10px] font-bold tabular-nums">
            <?php echo e(count($this->selectedShipments)); ?>
...
<?php endif; ?>
        ...
        <p class="px-2.5 pb-1.5 text-xs text-ink-muted">
            <?php echo e(count($this->selectedShipments)); ?> <?php echo e(__('merchant.orders_count')); ?>

        </p>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(canReassignOrders()): ?>
            <button wire:click="openBulkTrackingReassignModal" @click="open = false" type="button"
                ...
                <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'arrows-right-left','class' => 'w-4 h-4 shrink-0 text-ink-muted']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'arrows-right-left','class' => 'w-4 h-4 shrink-0 text-ink-muted']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal78f5a7347bd00ba3623a459cd340078c)): ?>
<?php $attributes = $__attributesOriginal78f5a7347bd00ba3623a459cd340078c; ?>
...
<?php unset($__componentOriginal78f5a7347bd00ba3623a459cd340078c); ?>
<?php endif; ?>
                <span><?php echo e(__('merchant.bulk_reassign')); ?></span>
            </button>
...
</div><?php /**PATH C:\laragon\www\edzeery\resources\views/livewire/merchant/tracking/partials/tracking-bulk-actions-bar.blade.php ENDPATH**/ ?>