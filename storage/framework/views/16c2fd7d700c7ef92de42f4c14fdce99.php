        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex gap-4">
                            <div class="flex-1 rounded-lg bg-brand-50 dark:bg-brand-950/40 p-4">
                                <div class="text-xs text-brand-600 dark:text-brand-400 font-medium"><?php echo e(__('landing.mock_revenue')); ?></div>
                            ...
                            <div class="flex-1 rounded-lg bg-green-50 dark:bg-green-950/40 p-4">
                                <div class="text-xs text-green-600 dark:text-green-400 font-medium"><?php echo e(__('landing.mock_orders')); ?></div>
                                <div class="mt-1 text-2xl font-bold text-ink">1,284</div>
                            </div>
                        </div>
                        <div class="rounded-lg bg-gray-50 dark:bg-gray-800 p-4">
                            <div class="text-xs text-gray-500 mb-2"><?php echo e(__('landing.mock_recent_orders')); ?></div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = range(1, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between py-2 <?php echo e($i < 3 ? 'border-b border-gray-100 dark:border-gray-700' : ''); ?>">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-ink"><?php echo e(__('landing.mock_customer_' . $i)); ?></div>
                                            <div class="text-xs text-gray-400"><?php echo e(rand(1, 5)); ?> <?php echo e(__('landing.mock_items')); ?></div>
                                        </div>
                                    </div>
                                    <div class="text-sm font-semibold text-ink"><?php echo e(rand(2000, 15000)); ?> <?php echo e(__('currency.DZD')); ?></div>
                                </div>
                ...
                <div class="absolute -bottom-4 -left-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-lg px-4 py-3 flex items-center gap-3">
                    ...
                    <div>
                        <div class="text-xs text-gray-500"><?php echo e(__('landing.mock_growth')); ?></div>
