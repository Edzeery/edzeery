                        ...
                        <div x-ref="mainGallery"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img x-show="active === <?php echo e($i); ?>"
                                    ...
                                    alt="<?php echo e($this->product->name); ?> â€” <?php echo e($i + 1); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge-wire','data' => ['domain' => 'general','status' => 'featured','set' => 'bi','class' => 'absolute top-4 '.e(algin()).'-4 z-10 shadow-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => 'featured','set' => 'bi','class' => 'absolute top-4 '.e(algin()).'-4 z-10 shadow-lg']); ?>
...
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->product->images->count() > 1): ?>
                            <div class="flex gap-2.5 overflow-x-auto pb-1 scrollbar-hide" x-ref="thumbs">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" data-slide-index="<?php echo e($i); ?>"
                        ...
                        <div
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->product->is_featured): ?>
                                <span
                                    ...
                                    <?php if (isset($component)) { $__componentOriginalefcb2882a5f330bfa0dcb7a898acac73 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalefcb2882a5f330bfa0dcb7a898acac73 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge-wire','data' => ['domain' => 'general','status' => 'featured','set' => 'bi']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('status-badge-wire'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => 'featured','set' => 'bi']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalefcb2882a5f330bfa0dcb7a898acac73)): ?>
<?php $attributes = $__attributesOriginalefcb2882a5f330bfa0dcb7a898acac73; ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col" x-data="productInfo(JSON.parse($el.dataset.variants || '{}'), $el.dataset.labelLowStock, $el.dataset.labelInStock, $el.dataset.labelOutOfStock, $el.dataset.labelOutShort, $el.dataset.labelAddToCart)"
                    data-variants="<?php echo e(json_encode($__variantPayload, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP)); ?>"
                    data-label-low-stock="<?php echo e(__('storefront.low_stock', ['count' => ':count'])); ?>"
                    data-label-in-stock="<?php echo e(__('storefront.in_stock')); ?>"
                    data-label-out-of-stock="<?php echo e(__('storefront.out_of_stock')); ?>"
                    data-label-out-short="<?php echo e(__('storefront.out_of_stock_short')); ?>"
                    data-label-add-to-cart="<?php echo e(__('storefront.add_to_cart')); ?>">
...
<?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e($__rpUrl); ?>"
                                                ...
                                                <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'adjustments-horizontal','class' => 'w-5 h-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'adjustments-horizontal','class' => 'w-5 h-5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal78f5a7347bd00ba3623a459cd340078c)): ?>
<?php $attributes = $__attributesOriginal78f5a7347bd00ba3623a459cd340078c; ?>
