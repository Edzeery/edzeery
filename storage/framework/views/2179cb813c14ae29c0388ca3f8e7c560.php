    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->product): ?>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-8">
                <a href="/" class="hover:text-gray-700 dark:hover:text-gray-200 transition"><?php echo e($this->product->store->name ?? __('storefront.back_to_store')); ?></a>
                <span>/</span>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->product->categories->first()): ?>
                    <span class="hover:text-gray-700 dark:hover:text-gray-200 transition"><?php echo e($this->product->categories->first()->name); ?></span>
                    <span>/</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div x-data="productGallery()" class="space-y-4" dir="ltr">
                    ...
                    <div x-show="lightbox" x-transition.opacity class="fixed inset-0 z-[100] bg-black/90 backdrop-blur-sm flex items-center justify-center" @click.self="lightbox = false" @keydown.escape.window="lightbox = false" @keydown.left.window="if(lightbox) prev()" @keydown.right.window="if(lightbox) next()" style="display:none">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <img x-show="active === <?php echo e($i); ?>" x-transition src="<?php echo e(asset('storage/' . $img->path)); ?>" alt="<?php echo e($this->product->name); ?>" class="max-w-[90vw] max-h-[85vh] object-contain rounded-lg" onerror="this.onerror=null;this.src='<?php echo e(asset('img/icons/noimg.png')); ?>'" draggable="false">
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex flex-col"
                     x-data="productInfo(<?php echo json_encode($__variantPayload); ?>, <?php echo \Illuminate\Support\Js::from(__('storefront.low_stock', ['count' => ':count']))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from(__('storefront.in_stock'))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from(__('storefront.out_of_stock'))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from(__('storefront.out_of_stock_short'))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from(__('storefront.add_to_cart'))->toHtml() ?>)">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->product->brand): ?>
                        <span class="text-sm font-semibold store-text-primary uppercase tracking-wider mb-2"><?php echo e($this->product->brand->name); ?></span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4"><?php echo e($this->product->name); ?></h1>
                    ...
                    <div class="mb-4">
                        ...
                        <template x-if="!activeVariant">
                            <div class="flex items-center flex-wrap gap-x-3 gap-y-1">
                                <span class="text-3xl font-bold store-text-primary"><?php echo e(currency($__minVariantPrice ?: $this->product->price)); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($__imageDiscountPercent > 0 && $__maxComparePrice > 0): ?>
                                    <span class="text-lg text-gray-400 dark:text-gray-500 line-through"><?php echo e(currency($__maxComparePrice)); ?></span>
                                    <span class="text-xs font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 px-2 py-1 rounded-full">-<?php echo e($__imageDiscountPercent); ?>%</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </template>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->product->short_description): ?>
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-6"><?php echo e($this->product->short_description); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->product->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <button
                                        type="button"
                                        x-on:click="select('<?php echo e($variant->id); ?>')"
                                    ...
                                    >
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($__outOfStock): ?>
                                            <span class="ml-1 text-xs font-semibold text-red-500 dark:text-red-400 no-underline"><?php echo e(__('storefront.out_of_stock_short')); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </button>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $__initialOutOfStock): ?>
                        <div class="mb-8">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3"><?php echo e(__('storefront.quantity')); ?></label>
                    ...
                    >
                        ...
                        <span x-text="isOutOfStock ? outOfStockShortLabel : addToCartLabel" wire:loading.remove wire:target="addToCart"><?php echo e(__('storefront.add_to_cart')); ?></span>
                        <span wire:loading class="hidden" wire:target="addToCart"><?php echo e(__('storefront.placing')); ?></span>
                    </button>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->relatedProducts->count()): ?>
                <section class="mt-16 pt-12 border-t border-gray-200 dark:border-gray-700">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-8"><?php echo e(__('storefront.you_may_also_like')); ?></h2>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition group relative flex flex-col">
                                ...
                                <div class="p-4 flex flex-col flex-1">
                                    <a href="<?php echo e($__rpUrl); ?>">
                                        <h3 class="font-semibold text-gray-900 dark:text-white text-sm mb-1 line-clamp-2"><?php echo e($rp->name); ?></h3>
                                    </a>

                                    <div class="flex items-center flex-wrap gap-x-2 gap-y-1 mt-2">
                                        <span class="text-lg font-bold store-text-primary"><?php echo e(currency($__rpMinPrice)); ?></span>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($__rpDiscount > 0): ?>
                                            <span class="text-xs font-medium text-gray-400 dark:text-gray-500 line-through"><?php echo e(currency($__rpMaxCompare)); ?></span>
