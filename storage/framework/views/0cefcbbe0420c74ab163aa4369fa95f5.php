            ...
            <tbody class="divide-y divide-gray-100 dark:divide-white/[0.05]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="px-6 py-3.5">
                            <div class="flex items-center">
                                <p class="text-gray-500 text-theme-sm dark:text-gray-400"><?php echo e($order['category']); ?></p>
                            </div>
                        </td>
                        <td class="px-6 py-3.5">
                            <div class="flex items-center">
                                <div class="w-5 h-5 overflow-hidden rounded-full">
                                    <img src="<?php echo e($order['countryFlag']); ?>" alt="<?php echo e($order['country']); ?>" />
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-3.5">
                        ...
                        <td class="px-6 py-3.5">
                            <div class="flex items-center">
                                <p class="text-theme-sm text-success-600"><?php echo e($order['value']); ?></p>
                            </div>
                        </td>
                    </tr>
...
</div><?php /**PATH C:\laragon\www\edzeery\resources\views\components\tables\basic-tables\basic-tables-five.blade.php ENDPATH**/ ?>