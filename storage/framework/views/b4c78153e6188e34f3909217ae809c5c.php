...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'trash','class' => 'w-5 h-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
            <span><?php echo e(__('order_flow.trash_mode_hint')); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->trashCount > 0): ?>
                <span
                    class="inline-flex items-center justify-center min-w-[1.25rem] h-5 px-1.5 rounded-full text-[10px] font-semibold bg-danger-500 text-white leading-none"><?php echo e($this->trashCount); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if((canStore(\App\Enums\Store\StorePermissionEnum::ORDER_DELETE->value) || canFinalDeleteOrders()) && $this->trashCount > 0): ?>
...
<?php unset($__componentOriginal78f5a7347bd00ba3623a459cd340078c); ?>
<?php endif; ?>
                        <?php echo e(__('merchant.restore_all')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(canFinalDeleteOrders()): ?>
                    <button
                        x-on:click="EdzSwal.confirmAction('<?php echo e(__('order_flow.empty_trash_title')); ?>', '<?php echo e(__('order_flow.empty_trash_confirm', ['count' => $this->trashCount])); ?>', { confirmText: '<?php echo e(__('merchant.empty_trash')); ?>', confirmColor: '#ef4444' }).then((ok) => { if (ok) $wire.forceDeleteAll(); })"
...
<?php unset($__componentOriginal78f5a7347bd00ba3623a459cd340078c); ?>
<?php endif; ?>
                        <?php echo e(__('merchant.empty_trash')); ?>
...
</div><?php /**PATH C:\laragon\www\edzeery\resources\views/livewire/merchant/tracking/partials/tracking-trash-banner.blade.php ENDPATH**/ ?>