...
new class extends Component implements Livewire\Volt\Contracts\FunctionalComponent
{
    ...
    public function toggleRateActive(string $stateId): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('toggleRateActive'))->execute(...$arguments);
    }

    public function toggleAllRatesActive(): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('toggleAllRatesActive'))->execute(...$arguments);
    }
