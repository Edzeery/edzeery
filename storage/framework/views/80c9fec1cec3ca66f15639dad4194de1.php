...
new class extends Component implements Livewire\Volt\Contracts\FunctionalComponent
{
    ...
    public function hasIntegrationAdapter(): bool
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('hasIntegrationAdapter'))->execute(...$arguments);
    }
    ...
    public function testProviderConnection(): void
    {
        ...
        (new Actions\CallMethod('testProviderConnection'))->execute(...$arguments);
    }
    ...
    public function enableWebhook(string $id): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('enableWebhook'))->execute(...$arguments);
    }

    public function regenerateWebhook(string $id): void
    {
        $arguments = [static::$__context, $this, func_get_args()];

        (new Actions\CallMethod('regenerateWebhook'))->execute(...$arguments);
    }
