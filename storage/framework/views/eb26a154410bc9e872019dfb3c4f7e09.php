...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'check-circle','class' => 'w-5 h-5 text-emerald-600 dark:text-emerald-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div>
                        <h3 class="edz-card__title"><?php echo e(__('merchant_panel.current_plan')); ?></h3>
            ...
            <div class="edz-card--padded">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-ink-soft"><?php echo e(__('merchant_panel.plan')); ?></p>
                        <p class="text-lg font-bold text-ink mt-0.5"><?php echo e($subscription->plan?->name ?? '-'); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-ink-soft"><?php echo e(__('merchant_panel.status')); ?></p>
                        <div class="mt-1">
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <div class="px-6 py-4 border-t border-surface-border <?php echo e(!$loop->last ? '' : ''); ?>">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
