...
<div class="w-full space-y-5">
    ...
    <div class="flex items-center gap-4 p-4 rounded-2xl shadow-card border border-surface-border bg-surface animate-fade-up"
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 flex-wrap">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->canViewBilling && !empty($this->subscription['plan_name'])): ?>
    ...
    <div class="grid grid-cols-3 gap-2 animate-fade-up" style="animation-delay: 0.1s">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->canViewBilling): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'status-kit::components.status-badge','data' => ['domain' => 'general','status' => $storeStatus->value]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['domain' => 'general','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($storeStatus->value)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="flex items-center gap-2 mt-auto pt-1">
                        <form method="POST" action="<?php echo e(route('merchant.choose-store.select', $store['slug'])); ?>" class="contents">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
