...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.page-header','data' => ['title' => ''.e(__('brands.title')).'','description' => ''.e(__('brands.subtitle', ['store' => currentStore()?->name])).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('brands.title')).'','description' => ''.e(__('brands.subtitle', ['store' => currentStore()?->name])).'']); ?>
...
<?php endif; ?>
                    <?php echo e(__('brands.add_brand')); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isNew || $editingId): ?>
        <div class="edz-card mb-6">
            <div class="edz-card__header">
                <div>
                    <h2 class="edz-card__title"><?php echo e($isNew ? __('brands.add_brand') : __('brands.edit_brand')); ?></h2>
                    <p class="text-sm text-ink-400"><?php echo e($isNew ? __('brands.create_details') : __('brands.update_details')); ?></p>
                </div>
            </div>
                                ...
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->canDelete()): ?>
                                        <button type="button" class="edz-btn edz-btn--ghost edz-btn--sm text-danger-600 hover:text-danger-700"
                                                x-data
                                                data-delete-name="<?php echo e($brand->name); ?>"
                                                data-delete-id="<?php echo e($brand->id); ?>"
