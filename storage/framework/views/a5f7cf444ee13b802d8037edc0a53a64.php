<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <div class="hidden xl:block">
                <form>
                    <div class="relative">
                        <span
                            class="absolute -translate-y-1/2 pointer-events-none <?php echo e($isRtl ? 'right-4' : 'left-4'); ?> top-1/2">
                            <!-- Search Icon -->
                        ...
                        <input type="text" placeholder="Search or type command..."
                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 <?php echo e($isRtl ? 'pr-12 pl-14' : 'pl-12 pr-14'); ?> text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-white/3 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]" />
                        <button
                            class="absolute <?php echo e($isRtl ? 'left-2.5' : 'right-2.5'); ?> top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400">
                            <span> ⌘ </span>
                            <span> K </span>
                        </button>
                    </div>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            gap-4 px-5 py-4 xl:flex shadow-theme-md
            xl:justify-end xl:px-0 xl:shadow-none">
...
<?php endif; ?>
            ...
            <!-- User Dropdown -->
            <?php if (isset($component)) { $__componentOriginal6acfbf5296d33152070b7e7d7b726d9a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6acfbf5296d33152070b7e7d7b726d9a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.header.user-dropdown','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6acfbf5296d33152070b7e7d7b726d9a)): ?>
<?php $attributes = $__attributesOriginal6acfbf5296d33152070b7e7d7b726d9a; ?>
<?php unset($__attributesOriginal6acfbf5296d33152070b7e7d7b726d9a); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal6acfbf5296d33152070b7e7d7b726d9a)): ?>
<?php $component = $__componentOriginal6acfbf5296d33152070b7e7d7b726d9a; ?>
<?php unset($__componentOriginal6acfbf5296d33152070b7e7d7b726d9a); ?>
<?php endif; ?>
        </div>
    </div>
</header>
<?php /**PATH C:\laragon\www\edzeery\resources\views/layouts/app-header.blade.php ENDPATH**/ ?>