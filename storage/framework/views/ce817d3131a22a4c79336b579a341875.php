...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'eye','class' => 'w-5 h-5 text-accent-fg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'eye','class' => 'w-5 h-5 text-accent-fg']); ?>
...
<?php /**PATH C:\laragon\www\edzeery\resources\views/livewire/merchant/storefront-settings/partials/preview-modal.blade.php ENDPATH**/ ?>