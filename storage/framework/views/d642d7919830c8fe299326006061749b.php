...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'arrow-'.e($algin).'','class' => 'w-4 h-4 text-base']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'arrow-'.e($algin).'','class' => 'w-4 h-4 text-base']); ?>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->delivery_type === 'stopdesk'): ?>
                        <div class="sm:col-span-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stopdesks->count()): ?>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                    <?php echo e(__('storefront.select_stopdesk_point')); ?>

                                    <span class="font-normal text-gray-400 text-xs">(<?php echo e(__('storefront.desk_optional_hint')); ?>)</span>
                                </label>
                                ...
                                class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600
                                       ...
                                       shadow-sm focus:outline-none focus:ring-2 focus:border-[var(--store-primary)]
                                       transition-all duration-200">
                                    <option value=""><?php echo e(__('storefront.no_desk_preference')); ?></option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stopdesks->groupBy('shipping_provider_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $providerId => $points): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <optgroup label="<?php echo e($deskProviders[$providerId] ?? __('storefront.stop_desk')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                                ...
                                <div class="rounded-xl border px-4 py-3 text-sm
                                    ...
                                    <?php elseif(! $this->city_id): ?>
                                        <?php echo e(__('storefront.select_city_for_desks')); ?>

                                    <?php else: ?>
                                        <?php echo e(__('storefront.no_desks_in_commune')); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-right shrink-0">
                                ...
                                <p class="text-xs text-gray-400 dark:text-gray-500">أ— <?php echo e($item['quantity']); ?></p>
                            </div>
                        </div>
