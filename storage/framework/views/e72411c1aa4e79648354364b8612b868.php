...
}" x-init="selectedTemplate = $root.dataset.selectedTemplate" data-selected-template="<?php echo e($template); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'storefront','class' => 'w-5 h-5 text-accent-fg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'storefront','class' => 'w-5 h-5 text-accent-fg']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-accent-fg font-mono"><?php echo e($store->public_url); ?></p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    <button type="button" data-copy-url="<?php echo e($store->public_url); ?>" x-data="{ copied: false }"
...
<?php endif; ?></span>
                    ...
                    <button type="button" x-on:click="openPreview()" data-preview-url="<?php echo e($store->public_url); ?>"
...
<?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <span
                                                class="text-ink-muted"><?php echo e(__('merchant_panel.template_product_auto')); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </span>
                                    <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
                                ...
                                <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                                    ...
                                    <div class="flex items-center justify-between gap-2 px-1 mb-2 sm:hidden">
                                        <p class="inline-flex items-center gap-1.5 text-xs font-semibold text-ink uppercase tracking-wide">
                                            <?php if (isset($component)) { $__componentOriginal78f5a7347bd00ba3623a459cd340078c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal78f5a7347bd00ba3623a459cd340078c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edz.icon','data' => ['name' => 'shopping-bag','class' => 'w-3.5 h-3.5 text-ink-muted']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('edz.icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'shopping-bag','class' => 'w-3.5 h-3.5 text-ink-muted']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal78f5a7347bd00ba3623a459cd340078c)): ?>
<?php $attributes = $__attributesOriginal78f5a7347bd00ba3623a459cd340078c; ?>
...
<?php unset($__componentOriginal78f5a7347bd00ba3623a459cd340078c); ?>
<?php endif; ?>
                                            <span><?php echo e(__('merchant_panel.template_product')); ?></span>
                                        </p>
                                    ...
                                    <ul class="max-h-56 overflow-y-auto py-1" role="listbox">
                                        <li>
                                            <button type="button" data-picker-value=""
                                                ...
                                                class="w-full text-start px-3 py-2.5 text-sm hover:bg-surface-secondary transition flex items-center justify-between gap-2 <?php echo e($chosenPickerProduct ? '' : 'store-text-primary font-semibold'); ?>">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->pickerOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickerProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li wire:key="picker-opt-<?php echo e($pickerProduct->id); ?>">
                                                <button type="button" data-picker-value="<?php echo e($pickerProduct->id); ?>"
                                                    x-on:click="$wire.set('section_content.single_product.product_id', $el.dataset.pickerValue); $wire.set('picker_query', ''); open = false"
                                                    class="w-full text-start px-3 py-2.5 text-sm hover:bg-surface-secondary transition flex items-center justify-between gap-2 <?php echo e($isChosen ? 'store-text-primary font-semibold' : ''); ?>">
...
<?php endif; ?>
                            ...
                            <p class="text-xs text-ink-muted mt-1"><?php echo e(__('merchant_panel.template_product_hint')); ?>
                        ...
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sectionConfig; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($key === 'hero'): ?>
                                    <div x-show="$wire.template !== 'single_product'">
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php echo $__env->make('livewire.merchant.storefront-settings.partials.section-editor', [
                                    'key' => $key,
                                    'section' => $section,
