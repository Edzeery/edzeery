...
<?php endif; ?>
            ...
            <div x-show="open" x-cloak
                ...
                class="absolute z-20 p-3 rounded-xl border border-surface-border bg-surface shadow-lg grid grid-cols-7 gap-1 w-[min(22rem,90vw)] <?php echo e($i === 2 ? 'bottom-full mb-2' : 'top-full mt-2'); ?>"
