                        ...
                        <td class="px-4 py-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s['tracking_status']): ?>
                                <button type="button" wire:click="openStatusHistory('<?php echo e($s['id']); ?>')"
                                    title="<?php echo e(__('order_flow.tracking_history')); ?>"
                                    class="inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full cursor-pointer hover:opacity-80 <?php echo e(\Edzeery\MyStatusKit\Facades\Status::for('tracking', $s['tracking_status'])->color()); ?>">
